    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api RahmXBot - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=62856541270717">WhatsApp</a></span></span>
      ...
      let mailOptions = {
        from: '"RahmXBot Api" <support.link2u.biz.id>',
        to: email,
        subject: `Verify Email - Api RahmXBot`,
        html: inboxGmail,
      };
